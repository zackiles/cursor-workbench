...
export const GeneralTab = ({ vscode }: GeneralTabProps) => {
  ...
  const renderRegistrySection = (
    ...
    const fileCountKey = `${type}RegistryFileCount` as
      | 'userRegistryFileCount'
    ...
    <div>
      ...
      <div className='registry-section'>
        {renderRegistrySection(
          'team',
          'Team Rules',
          'Manage your custom team rules and preferences'
        )}
        ...
        <div className='setting-item'>
          <div className='setting-info'>
            <div className='setting-title-section'>
              ...
              >
                <title>
                  Set this extension as the default editor for configured file
                  types
                </title>
                <path d='M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z' />
              </svg>
        ...
        <div className='setting-item'>
          <div className='setting-info'>
            <div className='setting-title-section'>
              ...
              >
                <title>
                  Configure which file extensions are treated as rule files
                </title>
                <path d='M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z' />
              </svg>
            </div>
            <p className='setting-description'>
              Configure file extensions that are treated as rule files (e.g.,
              .rule, .mdc)
            </p>
          </div>
          <div className='setting-control'>
            <div className='extensions-list'>
              {settingsState.editorSettings.enabledExtensions.map(
                (ext, index) => (
                  <span key={ext} className='extension-tag'>
                    ...
                    <button
                      ...
                      onClick={() => {
                        const newExtensions =
                          settingsState.editorSettings.enabledExtensions.filter(
                            (_, i) => i !== index
                          )
              ...
              <input
                ...
                onKeyDown={(e) => {
                  if (e.key === 'Enter') {
                    ...
                    if (
                      newExt &&
                      !settingsState.editorSettings.enabledExtensions.includes(
                        newExt
                      )
                    ) {
                      handleUpdateExtensions([
                        ...settingsState.editorSettings.enabledExtensions,
                        newExt
                      ])
                      target.value = ''
                    }
