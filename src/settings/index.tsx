...
const tabs: TabConfig[] = [
  {
    ...
    label: 'General',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-label="Settings">
  ...
  },
  {
    ...
    label: 'Debug',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-label="Debug">
        <title>Debug</title>
  ...
  },
  {
    ...
    label: 'Docs',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-label="Documentation">
